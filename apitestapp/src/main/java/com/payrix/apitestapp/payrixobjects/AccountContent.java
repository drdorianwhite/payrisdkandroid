package com.payrix.apitestapp.payrixobjects;
...
public class AccountContent {
    ...
    private static AccountItem createAccountItem(int position) {
        return new AccountItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    public static class AccountItem {
        ...
        public AccountItem(String id, String content, String details) {
            this.id = id;
